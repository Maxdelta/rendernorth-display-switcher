...
internal sealed class RnHeader : RnCard
{
    ...
    public RnHeader(string version, EventHandler settings, EventHandler update)
    {
        ...
        grid.Controls.Add(new Label { Text = "Environments", ForeColor = Color.White, Font = new Font("Segoe UI Semibold", 22), AutoSize = false, MinimumSize = new Size(0, 48), Height = 48, Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleLeft, Margin = new Padding(0, 0, 0, 8) }, 1, 1);
